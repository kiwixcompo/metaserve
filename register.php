                ...
                <div class="clean-card p-4 p-md-5 bg-white shadow-sm" style="border-radius: 15px; border-top: 5px solid var(--primary-color);">
                    ...
                    <form id="registerForm" method="POST" action="register.php">
                        ...
                        <div class="form-step" id="step-3">
                            <h5 class="text-white p-2 rounded mb-4 fw-bold" style="background: var(--primary-color);">3. PROGRAMME SELECTION</h5>
...
<script>
    ...
    function nextStep(step) {
        ...
        if(step === 4) {
            if(!document.getElementById('programme_id').value || !document.getElementById('faculty_interest').value) {
                alert('Please complete Programme Selection.');
                return;
            }
        }
    ...
    function submitForm() {
        ...
        // Step 3 Check
        if(!document.getElementById('programme_id').value || !document.getElementById('faculty_interest').value) {
            alert('Please complete Programme Selection in Step 3.');
            goToStep(3);
            return;
        }
