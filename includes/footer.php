        ...
        <div class="row gy-4">
            ...
            <div class="col-md-2 offset-md-2">
                ...
                <ul class="list-unstyled">
                    <li><a href="#" class="text-muted text-decoration-none d-block mb-2 hover-text-primary">About Us</a></li>
                    <li><a href="#" class="text-muted text-decoration-none d-block mb-2 hover-text-primary">Courses</a></li>
                    <li><a href="#" class="text-muted text-decoration-none d-block mb-2 hover-text-primary">Contact</a></li>
                </ul>
            </div>
            <div class="col-md-4">
                <h6 class="text-dark mb-4 fw-bold">Connect With Us</h6>
                <div class="d-flex gap-3">
                    <a href="#" class="btn btn-outline-custom d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; padding: 0;"><i class="fa-brands fa-facebook-f"></i></a>
                    <a href="#" class="btn btn-outline-custom d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; padding: 0;"><i class="fa-brands fa-twitter"></i></a>
                    <a href="#" class="btn btn-outline-custom d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; padding: 0;"><i class="fa-brands fa-linkedin-in"></i></a>
                </div>
            </div>
        </div>
